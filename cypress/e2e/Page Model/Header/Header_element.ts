export class Header_Element{
    ...
    header_our_service_btn = '[data-test-id="service"]'
    header_document_btn = '[data-test-id="document"]'
    header_event_btn = '[data-test-id="event"]'
    header_career_btn = '[data-test-id="career"]'
    header_contact_btn = '[data-test-id="contact"]'
