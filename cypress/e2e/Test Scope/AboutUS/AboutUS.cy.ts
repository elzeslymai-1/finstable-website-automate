    ...
    context('About US Test Case',()=>{
        context('Check About Us',()=>{
            it('[Click] => Read More btn',()=>{
                ...
                assert.check_text(element.read_less_btn,'Read Less')
            })
        ...
        context('Check Our Vision Mission',()=>{
            ...
            it('[Text] => Vision Content Text',()=>{
                //assert
                assert.check_text(element.vision_content_txt,element.expect_vision_content_txt)
            })
            ...
            it('[Text] => Mission Content 1 Text',()=>{
                //assert
                assert.check_text(element.mission_content1_txt,element.expect_mission_content1_txt)
            })

            it('[Text] => Mission Content 2 Text',()=>{
                //assert
                assert.check_text(element.mission_content2_txt,element.expect_mission_content2_txt)
            })

            it('[Text] => Mission Content 3 Text',()=>{
                //assert
                assert.check_text(element.mission_content3_txt,element.expect_mission_content3_txt)
            })

            it('[Text] => Mission Content 4 Text',()=>{
                //assert
                assert.check_text(element.mission_content4_txt,element.expect_mission_content4_txt)
            })

            it('[Text] => Mission Content 5 Text',()=>{
                //assert
                assert.check_text(element.mission_content5_txt,element.expect_mission_content5_txt)
            })

            it('[Text] => Mission Content 6 Text',()=>{
                //assert
                assert.check_text(element.mission_content6_txt,element.expect_mission_content6_txt)
            })
        })
        ...
        context('Check Action Professional Team & Advisory Board',()=>{
            ...
            context('Check Action Advisory Board',()=>{
                ...
                it('[Click] => Advisory Card 1 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card1_modal)
                    assert.check_text(element.assert_advisory_card1_name_txt,element.expect_advisory_card1_name_txt)
                    assert.check_text(element.assert_advisory_card1_position_txt,element.expect_advisory_card1_position_txt)
                    assert.check_text(element.assert_advisory_card1_content_txt,element.expect_advisory_card1_content_txt)
                })
                ...
                it('[Click] => Advisory Card 2 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card2_modal)
                    assert.check_text(element.assert_advisory_card2_name_txt,element.expect_advisory_card2_name_txt)
                    assert.check_text(element.assert_advisory_card2_position_txt,element.expect_advisory_card2_position_txt)
                    assert.check_text(element.assert_advisory_card2_content_txt,element.expect_advisory_card2_content_txt)
                })
                ...
                it('[Click] => Advisory Card 3 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card3_modal)
                    assert.check_text(element.assert_advisory_card3_name_txt,element.expect_advisory_card3_name_txt)
                    assert.check_text(element.assert_advisory_card3_position_txt,element.expect_advisory_card3_position_txt)
                    assert.check_text(element.assert_advisory_card3_content_txt,element.expect_advisory_card3_content_txt)
                })
                ...
                it('[Click] => Advisory Card 4 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card4_modal)
                    assert.check_text(element.assert_advisory_card4_name_txt,element.expect_advisory_card4_name_txt)
                    assert.check_text(element.assert_advisory_card4_position_txt,element.expect_advisory_card4_position_txt)
                    assert.check_text(element.assert_advisory_card4_content_txt,element.expect_advisory_card4_content_txt)
                })
                ...
                it('[Click] => Advisory Card 5 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card5_modal)
                    assert.check_text(element.assert_advisory_card5_name_txt,element.expect_advisory_card5_name_txt)
                    assert.check_text(element.assert_advisory_card5_position_txt,element.expect_advisory_card5_position_txt)
                    assert.check_text(element.assert_advisory_card5_content_txt,element.expect_advisory_card5_content_txt)
                })
                ...
                it('[Click] => Advisory Card 6 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card6_modal)
                    assert.check_text(element.assert_advisory_card6_name_txt,element.expect_advisory_card6_name_txt)
                    assert.check_text(element.assert_advisory_card6_position_txt,element.expect_advisory_card6_position_txt)
                    assert.check_text(element.assert_advisory_card6_content_txt,element.expect_advisory_card6_content_txt)
                })
                ...
                it('[Click] => Advisory Card 7 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card7_modal)
                    assert.check_text(element.assert_advisory_card7_name_txt,element.expect_advisory_card7_name_txt)
                    assert.check_text(element.assert_advisory_card7_position_txt,element.expect_advisory_card7_position_txt)
                    assert.check_text(element.assert_advisory_card7_content_txt,element.expect_advisory_card7_content_txt)
                })
                ...
                it('[Click] => Advisory Card 8 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.advisory_card8_modal)
                    assert.check_text(element.assert_advisory_card8_name_txt,element.expect_advisory_card8_name_txt)
                    assert.check_text(element.assert_advisory_card8_position_txt,element.expect_advisory_card8_position_txt)
                    assert.check_text(element.assert_advisory_card8_content_txt,element.expect_advisory_card8_content_txt)
                })
            ...
            context('Check Action Professional Team',()=>{
                ...
                it('[Click] => Professional Card 1 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card1_modal)
                    assert.check_text(element.assert_professional_card1_name_txt,element.expect_professional_card1_name_txt)
                    assert.check_text(element.assert_professional_card1_position_txt,element.expect_professional_card1_position_txt)
                    assert.check_text(element.assert_professional_card1_content_txt,element.expect_professional_card1_content_txt)
                })
                ...
                it('[Click] => Professional Card 2 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card2_modal)
                    assert.check_text(element.assert_professional_card2_name_txt,element.expect_professional_card2_name_txt)
                    assert.check_text(element.assert_professional_card2_position_txt,element.expect_professional_card2_position_txt)
                    assert.check_text(element.assert_professional_card2_content_txt,element.expect_professional_card2_content_txt)
                })
                ...
                it('[Click] => Professional Card 3 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card3_modal)
                    assert.check_text(element.assert_professional_card3_name_txt,element.expect_professional_card3_name_txt)
                    assert.check_text(element.assert_professional_card3_position_txt,element.expect_professional_card3_position_txt)
                    assert.check_text(element.assert_professional_card3_content_txt,element.expect_professional_card3_content_txt)
                })
                ...
                it('[Click] => Professional Card 4 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card4_modal)
                    assert.check_text(element.assert_professional_card4_name_txt,element.expect_professional_card4_name_txt)
                    assert.check_text(element.assert_professional_card4_position_txt,element.expect_professional_card4_position_txt)
                    assert.check_text(element.assert_professional_card4_content_txt,element.expect_professional_card4_content_txt)
                })
                ...
                it('[Click] => Professional Card 5 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card5_modal)
                    assert.check_text(element.assert_professional_card5_name_txt,element.expect_professional_card5_name_txt)
                    assert.check_text(element.assert_professional_card5_position_txt,element.expect_professional_card5_position_txt)
                    assert.check_text(element.assert_professional_card5_content_txt,element.expect_professional_card5_content_txt)
                })
                ...
                it('[Click] => Professional Card 6 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card6_modal)
                    assert.check_text(element.assert_professional_card6_name_txt,element.expect_professional_card6_name_txt)
                    assert.check_text(element.assert_professional_card6_position_txt,element.expect_professional_card6_position_txt)
                    assert.check_text(element.assert_professional_card6_content_txt,element.expect_professional_card6_content_txt)
                })
                ...
                it('[Click] => Professional Card 7 btn',()=>{
                    ...
                    assert.check_text(element.assert_professional_card7_name_txt,element.expect_professional_card7_name_txt)
                    assert.check_text(element.assert_professional_card7_position_txt,element.expect_professional_card7_position_txt)
                    assert.check_text(element.assert_professional_card7_content_txt,element.expect_professional_card7_content_txt)
                })
                ...
                it('[Click] => Professional Card 8 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card8_modal)
                    assert.check_text(element.assert_professional_card8_name_txt,element.expect_professional_card8_name_txt)
                    assert.check_text(element.assert_professional_card8_position_txt,element.expect_professional_card8_position_txt)
                    assert.check_text(element.assert_professional_card8_content_txt,element.expect_professional_card8_content_txt)
                })
                ...
                it('[Click] => Professional Card 9 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card9_modal)
                    assert.check_text(element.assert_professional_card9_name_txt,element.expect_professional_card9_name_txt)
                    assert.check_text(element.assert_professional_card9_position_txt,element.expect_professional_card9_position_txt)
                    assert.check_text(element.assert_professional_card9_content_txt,element.expect_professional_card9_content_txt)
                })
                ...
                it('[Click] => Professional Card 10 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card10_modal)
                    assert.check_text(element.assert_professional_card10_name_txt,element.expect_professional_card10_name_txt)
                    assert.check_text(element.assert_professional_card10_position_txt,element.expect_professional_card10_position_txt)
                    assert.check_text(element.assert_professional_card10_content_txt,element.expect_professional_card10_content_txt)
                })
                ...
                it('[Click] => Professional Card 11 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card11_modal)
                    assert.check_text(element.assert_professional_card11_name_txt,element.expect_professional_card11_name_txt)
                    assert.check_text(element.assert_professional_card11_position_txt,element.expect_professional_card11_position_txt)
                    assert.check_text(element.assert_professional_card11_content_txt,element.expect_professional_card11_content_txt)
                })
                ...
                it('[Click] => Professional Card 12 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card12_modal)
                    assert.check_text(element.assert_professional_card12_name_txt,element.expect_professional_card12_name_txt)
                    assert.check_text(element.assert_professional_card12_position_txt,element.expect_professional_card12_position_txt)
                    assert.check_text(element.assert_professional_card12_content_txt,element.expect_professional_card12_content_txt)
                })
                ...
                it('[Click] => Professional Card 13 btn',()=>{
                    ...
                    //assert
                    assert.check_Element(element.professional_card13_modal)
                    assert.check_text(element.assert_professional_card13_name_txt,element.expect_professional_card13_name_txt)
                    assert.check_text(element.assert_professional_card13_position_txt,element.expect_professional_card13_position_txt)
                    assert.check_text(element.assert_professional_card13_content_txt,element.expect_professional_card13_content_txt)
                })
